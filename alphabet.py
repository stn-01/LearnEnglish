...
consonants_fricatives = ['f', 'v', 'θ', 'ð', 'z',
                         'ʃ', 'ʒ', 'h', 's']  # s
...
ALPHABET = {
    'a': {'name': 'eɪ', 'char_upper': 'A', 'char_lower': 'a',
          'sound': '[eɪ] / [æ]', 'alphabet_sound': 'eɪ',
          'short_sound': 'æ'},
    'e': {'name': 'i:', 'char_upper': 'E', 'char_lower': 'e',
          'sound': '[i:] / [e]', 'alphabet_sound': 'i:',
          'short_sound': 'e'},
    'i': {'name': 'aɪ', 'char_upper': 'I', 'char_lower': 'i',
          'sound': '[aɪ] / [ɪ]', 'alphabet_sound': 'aɪ',
          'short_sound': 'ɪ'},
    'y': {'name': 'waɪ', 'char_upper': 'Y', 'char_lower': 'y',
          'sound': '[aɪ] / [ɪ] / [j]', 'alphabet_sound': 'aɪ',
          'short_sound': 'ɪ'},
    'o': {'name': 'əʊ', 'char_upper': 'O', 'char_lower': 'o',
          'sound': '[əʊ] / [ɒ]', 'alphabet_sound': 'əʊ',
          'short_sound': 'ɒ'},
    'u': {'name': 'ju:', 'char_upper': 'U', 'char_lower': 'u',
          'sound': '[ju:] / [ʌ]', 'alphabet_sound': 'ju:',
          'short_sound': 'ʌ'},
    ...
    'g': {'name': 'dʒi:', 'char_upper': 'G',
          'char_lower': 'g', 'sound': '[g] / [dʒ]'},
    ...
    'w': {'name': 'dʌblju:', 'char_upper': 'W', 'char_lower': 'w',
          'sound': '[w]'},
    ...
    'c': {'name': 'si:', 'char_upper': 'C', 'char_lower': 'c',
          'sound': '[s] / [k]'},

    'j': {'name': 'dʒeɪ', 'char_upper': 'J', 'char_lower': 'j',
          'sound': '[dʒ]'},

    'q': {'name': 'kju:', 'char_upper': 'Q', 'char_lower': 'q',
          'sound': '[kw]'},

    'h': {'name': 'eɪʈʃ', 'char_upper': 'H', 'char_lower': 'h',
          'sound': '[h]'},
    'x': {'name': 'eks', 'char_upper': 'X', 'char_lower': 'x',
          'sound': '[ks] / [gz]'},
}
